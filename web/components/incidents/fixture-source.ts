...
const noPrecedentIncident: Incident = {
  ...
  recommendations: [{ playbook_id: "PB-PROVIDER-DEGRADATION-001", action: "Validate provider_new health in Brazil and compare decline codes with an alternative connection.", recommendation_class: "INVESTIGATE", execution: "HUMAN_ONLY", rationale_evidence_ids: ["evd_current_rate_new", "evd_current_scope_new", "evd_current_declines_new"] }],
